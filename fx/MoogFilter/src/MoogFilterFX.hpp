...
private:
    ...
    float upsample_delay_line_L_;
    float upsample_delay_line_R_;
     ...
     * @param downsample_stages The 2 downsampling filter stages of the channel.
     * @param upsample_delay_line The delay line for the upsampling of the channel.
     */
    void process_main_channel(float* input_frames, float* output_frames, uint32_t frame_count, 
                                float filter_stages[4], float downsample_stages[2], float& upsample_delay_line);
